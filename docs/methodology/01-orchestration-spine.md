...
| §2 — Out of scope | What this project is *not*. Defended actively. |
...
- Append a `## Closure log` section with: date closed, Issue/PR numbers, step status, files added/modified/NOT-touched, sanity checks, what this unblocks.
